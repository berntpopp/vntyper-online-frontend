...
describe('BaseController', () => {
  ...
  describe('constructor() - Validation and initialization', () => {
    it('should throw error if dependencies is missing', () => {
      expect(() => new BaseController()).toThrow('BaseController: dependencies object is required');
    });
    ...
    it('should log initialization', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('[BaseController]', 'Controller initialized');
    });
  ...
  describe('on() - Subscribe to event', () => {
    ...
    it('should pass options to eventBus', () => {
      ...
      expect(mockEventBus.on).toHaveBeenCalledWith('test:event', expect.any(Function), options);
    });
  ...
  describe('emit() - Emit event', () => {
    ...
    it('should pass multiple arguments to eventBus', () => {
      ...
      expect(mockEventBus.emit).toHaveBeenCalledWith('test:event', 'arg1', 'arg2', 'arg3');
    });
  });
  ...
  describe('emitAsync() - Emit event asynchronously', () => {
    it('should emit event via eventBus asynchronously', async () => {
      ...
      expect(mockEventBus.emitAsync).toHaveBeenCalledWith('test:event', { data: 'test' });
    });
  ...
  describe('setState() - Set state value', () => {
    it('should delegate to stateManager.set()', () => {
      ...
      expect(mockStateManager.set).toHaveBeenCalledWith('jobs.job-123.status', 'completed');
    });
  });
  ...
  describe('handleError() - Handle errors consistently', () => {
    ...
    it('should log error without context', () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith('[BaseController]', 'Test error', error);
    });
  ...
  describe('destroy() - Cleanup resources', () => {
    ...
    it('should log destruction', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('[BaseController]', 'Controller destroyed');
    });
    ...
    it('should warn if already destroyed', () => {
      ...
      expect(mockLogger.warning).toHaveBeenCalledWith('[BaseController]', 'Already destroyed');
    });
  ...
  describe('_log() - Private logging', () => {
    it('should log with controller name prefix', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('[BaseController]', 'Test message');
    });
    ...
    it('should use subclass name in prefix', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('[TestController]', 'Test message');
    });
    ...
    it('should use logMessage interface if available', () => {
      ...
      expect(customLogger.logMessage).toHaveBeenCalledWith('[BaseController] Test message', 'info');
    });
