...
export class Job {
   ...
   */
  isTerminal() {
    return [Job.STATUS.COMPLETED, Job.STATUS.FAILED, Job.STATUS.CANCELLED].includes(this.status);
  }
   ...
   */
  isActive() {
    return [Job.STATUS.QUEUED, Job.STATUS.STARTED, Job.STATUS.PROCESSING].includes(this.status);
  }
