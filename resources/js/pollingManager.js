    ...
    start(id, pollFn, options = {}) {
        ...
        const poll = async () => {
            ...
            try {
                ...
                logMessage(`Polling error for ${id}: ${error.message} (retry ${retries}/${maxRetries})`, 'error');
        ...
        logMessage(`Started polling ${id} (interval: ${interval}ms, maxRetries: ${maxRetries})`, 'info');
